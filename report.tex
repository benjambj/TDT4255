...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{figures/with_carry_check.png}
  \caption{The path delay with carry checks}
  \label{fig:with_carry}
\end{figure}
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{figures/without_carry_check.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{figures/without_overflow_check.png}
